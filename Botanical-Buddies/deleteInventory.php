...
if (isset($_SESSION['user_id'])) {
    ...
    $sql = 'SELECT plant_name, plant_type, plant_description, plant_price, plant_quantity_available FROM plant_data';
...
<marquee class="announcement" behavior="scroll" direction="right" scrollamount="4">🌿coupon codes🌿</marquee>
    ...
    echo'
    <h2>Botanical Buddies Inventory</h2>
<div class="table-wrapper">
    <table class="fl-table" id="table1">
        <thead>
        <tr>
            <th onClick="sortTable(0)">Plant Name</th>
            <th onClick="sortTable(1)">Plant Type</th>
            <th onClick="sortTable(2)">Plant Description</th>
            <th onClick="sortTable(3)">Plant Price</th>
            <th onClick="sortTable(4)">Plant Quantity Available</th>
        </tr>
        </thead>
        <tbody>
       ';
    ...
    foreach ($orders as $order) {
        echo' <tr>
                ...
                <td>' . $order["plant_description"] . '</td>
                <td>' . $order["plant_price"] . '</td>
                <td>' . $order["plant_quantity_available"] . '</td>
